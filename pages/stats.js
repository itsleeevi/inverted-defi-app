...
const Bank = () => {
  ...
  const { AOS, connected, treasury } = useContext(PregmaContext);
  ...
  useEffect(() => {
    axios.get(url).then((response) => {
      ...
      setMarketcap(Number(response.data.pairs[0].priceUsd) * 20000000);
    });
  }, []);
